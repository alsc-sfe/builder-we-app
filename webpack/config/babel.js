...
const { CSS_SCOPE, SAAS_CONFIG } = require('../util/const');

const useReactCssModule = get(SAAS_CONFIG, 'useReactCssModule', true);
const pluginsReactCssModule = useReactCssModule ? [
